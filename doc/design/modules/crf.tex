...
\begin{algorithm}[Finalization$(state)$] \label{alg:CRF training}
...
\begin{algorithmic}[1]
        ...
        \State $state.g \set -state.g; state.loglikeli\set -state.loglikeli$ \Comment{negation for maximization}
