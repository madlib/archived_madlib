...
\algoutput{$X'$, an $n\times D$ dimension matrix of data in feature space to be sent to linear solver, as well as the $\Omega$ generated by the algorithm, to be used by the predictor.\\
}
\begin{algorithmic}[1]
