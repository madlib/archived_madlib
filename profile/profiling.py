...
# helper routine to query the database catalog and get column names for table
# "table" return value is a list of lists; the first list is the numeric
# columns, the second list is the non-numeric columns
