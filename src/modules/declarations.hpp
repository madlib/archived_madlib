...
// regress/linear.hpp
DECLARE_UDF_EXT(linregr_trans, regress, LinearRegression::transition)
DECLARE_UDF_EXT(linregr_prelim, regress, LinearRegression::preliminary)
...
DECLARE_UDF_EXT(logregr_cg_step_trans, regress, LogisticRegressionCG::transition)
DECLARE_UDF_EXT(logregr_cg_step_prelim, regress, LogisticRegressionCG::preliminary)
...
DECLARE_UDF_EXT(logregr_irls_step_trans, regress, LogisticRegressionIRLS::transition)
DECLARE_UDF_EXT(logregr_irls_step_prelim, regress, LogisticRegressionIRLS::preliminary)
