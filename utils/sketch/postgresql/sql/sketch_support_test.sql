CREATE FUNCTION sketch_rightmost_one(bytea, integer, integer) returns integer AS '$libdir/sketches'
LANGUAGE C STRICT;
CREATE FUNCTION sketch_leftmost_zero(bytea, integer, integer) returns integer AS '$libdir/sketches'
LANGUAGE C STRICT;
CREATE FUNCTION sketch_array_set_bit_in_place(bytea, integer, integer, integer, integer) returns bytea AS '$libdir/sketches'
LANGUAGE C STRICT;
